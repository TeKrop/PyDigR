...
#Site de provenance
#http://sujitpal.blogspot.fr/2014/07/handwritten-digit-recognition-with.html

#Installation
#http://pybrain.org/docs/#installation
#git clone git://github.com/pybrain/pybrain.git
#python setup.py install
#sudo apt-get python-matplotlib

#Non Reseau de neurones donc trop proche de celle de Valentin
...
data = scipy.io.loadmat("/home/auronmustang/scikit_learn_data/mldata/mnist-original.mat")
X = data["X"]
y = data["y"]
